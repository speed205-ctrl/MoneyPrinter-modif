...
# Environment variable fallback overrides for sensitive API keys & settings
env_key_mappings = {
    "openai_api_key": ["OPENAI_API_KEY", "MPT_OPENAI_API_KEY"],
    "openai_base_url": ["OPENAI_BASE_URL", "MPT_OPENAI_BASE_URL"],
    "gemini_api_key": ["GEMINI_API_KEY", "MPT_GEMINI_API_KEY"],
    "deepseek_api_key": ["DEEPSEEK_API_KEY", "MPT_DEEPSEEK_API_KEY"],
    "pexels_api_key": ["PEXELS_API_KEY", "MPT_PEXELS_API_KEY"],
    "pixabay_api_key": ["PIXABAY_API_KEY", "MPT_PIXABAY_API_KEY"],
    "azure_api_key": ["AZURE_API_KEY", "MPT_AZURE_API_KEY"],
    "elevenlabs_api_key": ["ELEVENLABS_API_KEY", "MPT_ELEVENLABS_API_KEY"],
}

for cfg_key, env_vars in env_key_mappings.items():
